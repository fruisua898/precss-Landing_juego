...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"iTYX":[function(require,module,exports) {
'use strict';

var grande = document.querySelector('.grande');
var punto = document.querySelectorAll('.punto');
console.log(grande, punto);
punto.forEach(function (eachPunto, i) {
  punto[i].addEventListener("click", function () {
    var posicion = i;
    var operacion = posicion * -(100 / 3);
...
//# sourceMappingURL=/carrusel.e7a60fde.js.map